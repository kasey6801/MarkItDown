...
**v0.44.3** - Convert documents, PDFs, Office files & more to Markdown, locally. Available for macOS ([v0.44.3 release](https://github.com/kasey6801/MarkItDown/releases/tag/v0.44.3)) and Windows ([v0.44.3 release](https://github.com/kasey6801/MarkItDown/releases/tag/v0.44.3)), both shipping app v0.44.3.
...
Download the `MarkItDown.dmg` installer from the [v0.44.3 Release](https://github.com/kasey6801/MarkItDown/releases/tag/v0.44.3) page. No Python installation required.
...
Download `MarkItDown.exe` from the [v0.44.3 release](https://github.com/kasey6801/MarkItDown/releases/tag/v0.44.3) page. No Python installation required.
...
1. Download `MarkItDown.exe` from the [v0.44.3 release](https://github.com/kasey6801/MarkItDown/releases/tag/v0.44.3).
